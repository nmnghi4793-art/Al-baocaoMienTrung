...
async def report_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not id_kho:
        # Không phải tin nhắn báo cáo -> bỏ qua cho đỡ ồn
        return
    ...
    # 3. Kiểm tra tên kho có khớp không (so sánh lowercase, bỏ khoảng trắng dư)
    ...
    today_key = now.date().isoformat()  # VD: "2025-11-22"
...
# ===== JOB 15H00: TỔNG HỢP KHO CHƯA BÁO CÁO =====
